...
fun HomeScreen(onStudyClick: () -> Unit) {
    ...
    // Due count/streak/reviews-today are loaded once, not observed reactively - without this,
    // coming back from a Study session leaves Home showing whatever was true before it started.
